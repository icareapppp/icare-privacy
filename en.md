...
- **Patient details:** Name, date of birth, medical information (blood type, allergies, chronic conditions, medications)
- **Care data:** Medications, appointments, tasks, health metrics, shifts
- **Documents:** Photos of medical documents
- **Chat messages:** Messages between family members

### Information collected automatically:
- **Notification token:** A unique identifier for sending notifications to your device
...
- **Family sharing:** Displaying information to authorized family members who have joined the group
...
- Automatic logout after one hour of inactivity
...
- **Member account deletion:** Deletes only that member's details
